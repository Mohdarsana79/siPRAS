...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Master Data
    Route::resource('master-ruangan', \App\Http\Controllers\MasterRuanganController::class)->except(['create', 'show', 'edit']);
    Route::resource('master-sumber-dana', \App\Http\Controllers\MasterSumberDanaController::class)->except(['create', 'show', 'edit']);
    Route::resource('master-kategori', \App\Http\Controllers\MasterKategoriController::class)->except(['create', 'show', 'edit']);

    // KIB (Kartu Inventaris Barang)
    Route::resource('kib-a', \App\Http\Controllers\KibATanahController::class)->except(['create', 'show', 'edit']);
    Route::resource('kib-b', \App\Http\Controllers\KibBPeralatanController::class)->except(['create', 'show', 'edit']);
    Route::resource('kib-c', \App\Http\Controllers\KibCGedungController::class)->except(['create', 'show', 'edit']);
    Route::resource('kib-d', \App\Http\Controllers\KibDJalanController::class)->except(['create', 'show', 'edit']);
    Route::resource('kib-e', \App\Http\Controllers\KibEAsetLainnyaController::class)->except(['create', 'show', 'edit']);
    Route::resource('kib-f', \App\Http\Controllers\KibFKonstruksiController::class)->except(['create', 'show', 'edit']);

    // Operasional
    Route::get('mutasi/cetak', [\App\Http\Controllers\MutasiBarangController::class, 'cetak'])->name('mutasi.cetak');
    Route::resource('mutasi', \App\Http\Controllers\MutasiBarangController::class)->only(['index', 'store', 'destroy']);
    Route::resource('peminjaman', \App\Http\Controllers\PeminjamanController::class)->only(['index', 'store', 'update', 'destroy']);
    Route::resource('pemeliharaan', \App\Http\Controllers\PemeliharaanController::class)->only(['index', 'store', 'destroy']);
