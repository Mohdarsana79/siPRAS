...
<body>
    ...
    <div style="text-align:center; margin-bottom:10px;">
        <strong style="font-size:11pt;">KARTU INVENTARIS BARANG (KIB) B</strong><br>
        <span style="font-size:10pt;">PERALATAN DAN MESIN</span>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="2" width="75">Kode Barang</th>
                <th rowspan="2" width="100">Nama/Jenis Barang</th>
                <th rowspan="2" width="25">Reg.</th>
                <th rowspan="2" width="80">Merk / Type</th>
                <th rowspan="2" width="55">Ukuran / CC</th>
                <th rowspan="2" width="55">Bahan</th>
                <th rowspan="2" width="45">Tahun Beli</th>
            ...
            <tr>
                <th width="55">Pabrik</th>
                <th width="65">Rangka</th>
                <th width="65">Mesin</th>
                <th width="55">Polisi</th>
                <th width="55">BPKB</th>
            </tr>
        </thead>
        <tbody>
