...
<body>
    ...
    <div style="text-align:center; margin-bottom:10px;">
        <strong style="font-size:11pt;">KARTU INVENTARIS BARANG (KIB) D</strong><br>
        <span style="font-size:10pt;">JALAN, IRIGASI DAN JARINGAN</span>
    </div>
    ...
    <table style="border: none; margin-bottom: 20px;">
        ...
        <tr>
            ...
            <td style="border: none;">:</td>
            <td style="border: none;">{{ str_replace('XX', '04', $profile->kode_lokasi_bmd) . '.' . date('Y') }}</td>
        </tr>
    </table>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="2" width="100">Konstruksi</th>
                <th rowspan="2" width="45">Panjang (m)</th>
                <th rowspan="2" width="45">Lebar (m)</th>
