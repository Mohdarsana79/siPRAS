...
<body style="font-size: {{ $fontSize }};">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <h4 style="margin: 0; text-transform: uppercase;">KARTU INVENTARIS BARANG (KIB) A</h4>
    ...
    <div style="margin-bottom: 15px;">
        <table style="width: 100%; border: none !important; table-layout: auto !important;">
            ...
            <tr>
                ...
                <td style="border: none !important; padding: 1px 0; text-align: center;">:</td>
                <td style="border: none !important; padding: 1px 0; text-align: left;">{{ str_replace('XX', '01', $profile->kode_lokasi_bmd) . '.' . date('Y') }}</td>
            </tr>
        </table>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="40" rowspan="2">Tahun Letak</th>
                <th width="100" rowspan="2">Letak / Alamat</th>
                <th colspan="3">Status Tanah</th>
                <th width="60" rowspan="2">Penggunaan</th>
                <th width="50" rowspan="2">Asal Usul</th>
                <th width="70" rowspan="2">Harga (Rp)</th>
                <th width="50" rowspan="2">Ket</th>
            </tr>
            <tr>
                <th width="60">Kode Barang</th>
                <th width="30">Reg.</th>
                <th width="40">Hak</th>
                <th width="50">Tgl Sertifikat</th>
                <th width="60">No. Sertifikat</th>
            </tr>
        </thead>
        <tbody>
            @php $total = 0; @endphp
