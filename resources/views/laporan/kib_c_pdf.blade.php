...
<body style="font-size: {{ $fontSize }};">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <h4 style="margin: 0; text-transform: uppercase;">KARTU INVENTARIS BARANG (KIB) C</h4>
        <h5 style="margin: 0; font-weight: normal;">GEDUNG DAN BANGUNAN</h5>
    </div>
    ...
    <div style="margin-bottom: 15px;">
        <table style="width: 100%; border: none !important; table-layout: auto !important;">
            ...
            <tr>
                ...
                <td style="border: none !important; padding: 1px 0; text-align: center;">:</td>
                <td style="border: none !important; padding: 1px 0; text-align: left;">{{ str_replace('XX', '03', $profile->kode_lokasi_bmd) . '.' . date('Y') }}</td>
            </tr>
        </table>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="40" rowspan="2">Kondi si</th>
                <th colspan="2">Konstruksi</th>
                <th width="40" rowspan="2">Luas Lantai (M2)</th>
                <th width="100" rowspan="2">Letak / Lokasi</th>
                <th colspan="2">Dokumen Gedung</th>
                <th width="40" rowspan="2">Luas tanah (M2)</th>
