    ...
    return (
        ...
        >
                        ...
                        <table className="w-full text-sm text-left border-collapse">
                            <thead className="bg-gradient-to-r from-indigo-600 to-violet-600">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 font-black text-white/90 uppercase tracking-widest text-[9pt]">Spesifikasi</th>
                                    <th className="px-6 py-4 font-black text-white/90 uppercase tracking-widest text-[9pt]">Identitas</th>
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex flex-col">
                                                ...
                                                <div className="flex flex-col gap-1 mt-1">
                                                    ...
                                                    <span className="text-[10px] font-mono font-black text-amber-700 bg-amber-50 px-2 py-0.5 rounded border border-amber-100 w-fit">
            ...
            <FormModal
                show={isModalOpen}
                onClose={closeModal}
                title={isEditing ? 'Edit Peralatan & Mesin' : 'Tambah Peralatan & Mesin'}
            ...
            >
                <div className="space-y-8">
                    ...
                    <div className="space-y-5">
                            <h4 className="text-[10pt] font-bold text-amber-600 tracking-tight">IDENTITAS ASET</h4>
                        </div>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <TextInput 
                                        ...
                                        required 
                                        placeholder="CONTOH: LAPTOP DELL XPS 13 / MEJA KERJA..." 
                                    />
                            ...
                            <div className="space-y-5 px-4 py-4 bg-gray-50/50 rounded-2xl border border-dashed border-gray-200">
                                ...
                                <div className="grid grid-cols-2 gap-x-4 gap-y-5">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <TextInput
                                            id="harga"
                                            className="font-bold text-amber-600 text-[9pt]"
                    ...
                    <div className="space-y-5 p-6 bg-amber-50/30 rounded-3xl border border-amber-100/50">
                            <h4 className="text-[10pt] font-bold text-amber-600 tracking-tight uppercase">SPESIFIKASI TEKNIS & LOKASI</h4>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <div className="space-y-1.5">
                                    <InputLabel htmlFor="merk_tipe" value="MERK / MODEL / TYPE" className="text-[9pt] font-semibold text-gray-500" />
                                    <TextInput id="merk_tipe" className="text-[9pt]" value={data.merk_tipe} onChange={(e) => setData('merk_tipe', e.target.value.toUpperCase())} required placeholder="MISAL: HONDA VARIO 150 / DELL XPS..." />
                                    <InputError message={errors.merk_tipe} className="mt-1 text-[9pt] font-bold" />
                                </div>
 
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="bahan" value="BAHAN / MATERIAL" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="bahan" className="text-[9pt]" value={data.bahan} onChange={(e) => setData('bahan', e.target.value.toUpperCase())} required placeholder="BESI / PLASTIK..." />
                                        <InputError message={errors.bahan} className="mt-1 text-[9pt] font-bold" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="tahun_pembuatan" value="TAHUN BUAT / BELI" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="tahun_pembuatan" className="text-[9pt]" value={data.tahun_pembuatan} onChange={(e) => setData('tahun_pembuatan', e.target.value)} required placeholder="YYYY" />
                                        <InputError message={errors.tahun_pembuatan} className="mt-1 text-[9pt] font-bold" />
                                    </div>
                                </div>
 
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="ukuran_cc" value="UKURAN / CC / KAPASITAS" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="ukuran_cc" className="text-[9pt]" value={data.ukuran_cc} onChange={(e) => setData('ukuran_cc', e.target.value.toUpperCase())} placeholder="MISAL: 150CC / 13 INCH..." />
                                        <InputError message={errors.ukuran_cc} className="mt-1 text-[9pt] font-bold" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="nomor_polisi" value="NOMOR POLISI (B 1234 ABC)" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="nomor_polisi" className="text-[9pt]" value={data.nomor_polisi} onChange={(e) => setData('nomor_polisi', e.target.value.toUpperCase())} placeholder="NAMA PLAT..." />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="nomor_rangka" value="NOMOR RANGKA" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="nomor_rangka" className="text-[9pt]" value={data.nomor_rangka} onChange={(e) => setData('nomor_rangka', e.target.value.toUpperCase())} placeholder="NO RANGKA..." />
                                    </div>
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="nomor_mesin" value="NOMOR MESIN / SERI" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="nomor_mesin" className="text-[9pt]" value={data.nomor_mesin} onChange={(e) => setData('nomor_mesin', e.target.value.toUpperCase())} placeholder="NO MESIN / SERI..." />
                                    </div>
                                </div>
 
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="nomor_bpkb" value="NOMOR BPKB" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="nomor_bpkb" className="text-[9pt]" value={data.nomor_bpkb} onChange={(e) => setData('nomor_bpkb', e.target.value.toUpperCase())} placeholder="NO BPKB..." />
                                    </div>
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="nomor_pabrik" value="NOMOR PABRIK" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="nomor_pabrik" className="text-[9pt]" value={data.nomor_pabrik} onChange={(e) => setData('nomor_pabrik', e.target.value.toUpperCase())} placeholder="NO PABRIK..." />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    <InputLabel htmlFor="keterangan" value="KETERANGAN LAINNYA" className="text-[9pt] font-semibold text-gray-500" />
                                    <textarea
                                        id="keterangan"
                                        className="w-full border-gray-100 focus:border-amber-400 focus:ring-4 focus:ring-amber-400/10 rounded-2xl py-2.5 text-[9pt] bg-white transition-all min-h-[80px]"
            ...
            <FormModal
                ...
                title="Detail Peralatan & Mesin"
                subtitle="Informasi Kartu Inventaris — KIB B"
                maxWidth="4xl"
                accentColor="amber"
                headerVariant="gradient"
                    ...
                    <div className="space-y-8 py-2">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[8pt] font-bold text-gray-400 uppercase tracking-wider">Ruangan</span>
                                            <span className="text-[9pt] font-bold text-gray-600 bg-gray-50 px-3 py-1 rounded-lg border border-gray-100 w-fit">{selectedItemForDetail.ruangan?.nama_ruangan || 'TIDAK TERHUBUNG RUANG'}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50/50 rounded-2xl border border-gray-100 p-5 space-y-4">
                                        {[
                                            ...
                                            { label: 'Bahan / Material', value: selectedItemForDetail.kib_b?.bahan },
                                            { label: 'Tahun Buat', value: selectedItemForDetail.kib_b?.tahun_pembuatan },
                                            { label: 'CC / Kapasitas', value: selectedItemForDetail.kib_b?.ukuran_cc || '-' },
                                            { label: 'No. Mesin / Seri', value: selectedItemForDetail.kib_b?.nomor_mesin || '-' },
                                            { label: 'No. Polisi', value: selectedItemForDetail.kib_b?.nomor_polisi || '-' },
                                            { label: 'No. BPKB', value: selectedItemForDetail.kib_b?.nomor_bpkb || '-' },
                                        ].map((d, i) => (
                                            <div key={i} className="flex justify-between items-center group">
                                                <span className="text-[8pt] font-bold text-gray-400 uppercase">{d.label}</span>
                                                <span className="text-[9pt] font-bold text-gray-700 text-right">{d.value}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            <div className="flex-1 min-w-[200px] bg-gray-50/50 p-4 rounded-2xl border border-gray-100 flex items-center justify-between">
                                <span className="text-[8pt] font-black text-gray-400 uppercase tracking-widest">Kondisi Aset</span>
                        ...
                        {selectedItemForDetail.keterangan && (
                            <div className="bg-amber-50/20 p-6 rounded-3xl border border-amber-100/50">
                                <h6 className="text-[8pt] font-black text-amber-600 uppercase tracking-[0.2em] mb-3">Catatan / Keterangan</h6>
