    ...
    return (
        ...
        >
                        ...
                        <table className="w-full text-sm text-left border-collapse">
                            <thead className="bg-gradient-to-r from-indigo-600 to-violet-600">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 font-black text-white/90 uppercase tracking-widest text-[9pt]">Lantai & Lokasi</th>
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex flex-col">
                                                ...
                                                <div className="flex flex-col gap-1 mt-1">
                                                    ...
                                                    <span className="text-[10px] font-mono font-black text-violet-700 bg-violet-50 px-2 py-0.5 rounded border border-violet-100 w-fit">
            ...
            <FormModal
                show={isModalOpen}
                onClose={closeModal}
                title={isEditing ? 'Edit Gedung & Bangunan' : 'Tambah Gedung & Bangunan'}
            ...
            >
                <div className="space-y-8">
                    ...
                    <div className="space-y-5">
                            <h4 className="text-[10pt] font-bold text-violet-600 tracking-tight">IDENTITAS ASET</h4>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-5">
                                ...
                                <div className="space-y-1.5">
                                    <InputLabel htmlFor="nama_barang" value="NAMA LENGKAP GEDUNG / BANGUNAN" className="text-[9pt] font-semibold text-gray-500" />
                                    <TextInput 
                                        id="nama_barang" 
                                        className="text-[9pt]" 
                                        ...
                                        required 
                                        placeholder="CONTOH: GEDUNG RUANG KELAS A / POS JAGA..." 
                                    />
                            ...
                            <div className="space-y-5 px-4 py-4 bg-gray-50/50 rounded-2xl border border-dashed border-gray-200">
                                ...
                                <div className="grid grid-cols-2 gap-x-4 gap-y-5">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <TextInput
                                            id="harga"
                                            className="font-bold text-violet-600 text-[9pt]"
                    ...
                    {/* section: Spesifikasi Gedung */}
                    <div className="space-y-5 p-6 bg-violet-50/30 rounded-3xl border border-violet-100/50">
                            <h4 className="text-[10pt] font-bold text-violet-600 tracking-tight uppercase">SPESIFIKASI GEDUNG & LOKASI</h4>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <div className="space-y-1.5">
                                    <InputLabel htmlFor="kondisi_bangunan" value="KONSTRUKSI BANGUNAN" className="text-[9pt] font-semibold text-gray-500" />
                                    <TextInput id="kondisi_bangunan" className="text-[9pt]" value={data.kondisi_bangunan} onChange={(e) => setData('kondisi_bangunan', e.target.value.toUpperCase())} required placeholder="MISAL: PERMANEN / SEMI PERMANEN..." />
                                    <InputError message={errors.kondisi_bangunan} className="mt-1 text-[9pt] font-bold" />
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-center p-3 bg-white/50 rounded-2xl border border-violet-100">
                                        <label className="flex items-center cursor-pointer group w-full">
                                            <div className="relative">
                                                ...
                                                <div className={`w-10 h-6 rounded-full transition-colors ${data.konstruksi_bertingkat ? 'bg-violet-600' : 'bg-gray-200'}`}></div>
                                            ...
                                            <span className="ms-3 text-[9pt] font-bold text-gray-500 uppercase group-hover:text-violet-600">Bertingkat</span>
                                        </label>
                                    </div>
                                    <div className="flex items-center p-3 bg-white/50 rounded-2xl border border-violet-100">
                                        <label className="flex items-center cursor-pointer group w-full">
                                            <div className="relative">
                                                ...
                                                <div className={`w-10 h-6 rounded-full transition-colors ${data.konstruksi_beton ? 'bg-violet-600' : 'bg-gray-200'}`}></div>
                                            ...
                                            <span className="ms-3 text-[9pt] font-bold text-gray-500 uppercase group-hover:text-violet-600">Beton</span>
                                        </label>
                                    </div>
                                </div>

                                <div className="space-y-1.5">
                                    <InputLabel htmlFor="luas_lantai" value="LUAS LANTAI (M²)" className="text-[9pt] font-semibold text-gray-500" />
                                    <TextInput id="luas_lantai" type="text" placeholder="0.00" className="text-[9pt]" value={data.luas_lantai} onChange={(e) => setData('luas_lantai', e.target.value)} required />
                                    <InputError message={errors.luas_lantai} className="mt-1 text-[9pt] font-bold" />
                                </div>

                                <div className="space-y-1.5">
                                    <InputLabel htmlFor="letak_alamat" value="ALAMAT LOKASI GEDUNG" className="text-[9pt] font-semibold text-gray-500" />
                                    <textarea
                                        id="letak_alamat"
                                        className="w-full border-gray-100 focus:border-violet-400 focus:ring-4 focus:ring-violet-400/10 rounded-2xl py-2.5 text-[9pt] bg-white transition-all min-h-[80px]"
                                        value={data.letak_alamat}
                                        onChange={(e) => setData('letak_alamat', e.target.value)}
                                        required
                                        placeholder="TULIS ALAMAT LENGKAP GEDUNG..."
                                    />
                                    <InputError message={errors.letak_alamat} className="mt-1 text-[9pt] font-bold" />
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="dokumen_tanggal" value="TGL DOKUMEN (IMB/DLL)" className="text-[9pt] font-semibold text-gray-500" />
                                        <ModernDatePicker
                                            id="dokumen_tanggal"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1.5">
                                        <InputLabel htmlFor="kode_tanah" value="KODE TANAH (OPSIONAL)" className="text-[9pt] font-semibold text-gray-500" />
                                        <TextInput id="kode_tanah" className="text-[9pt]" value={data.kode_tanah || ''} onChange={(e) => setData('kode_tanah', e.target.value.toUpperCase())} placeholder="KODE..." />
                                    </div>
                                </div>

                                <SearchableSelect
                                    label="HUBUNGKAN DENGAN RUANGAN (OPSIONAL)"
                                    isMulti={true}
                    ...
                    <div className="group/field">
                        <InputLabel htmlFor="keterangan" value="KETERANGAN LAINNYA" className="mb-1 text-[9pt] font-semibold text-gray-500" />
                        <textarea
                            id="keterangan"
                            className="w-full px-4 rounded-md border-gray-300 bg-white py-2 font-medium text-gray-600 focus:ring-1 focus:ring-violet-500 focus:border-violet-500 transition-all text-[9pt] outline-none resize-none"
                            rows={2}
            ...
            <FormModal
                ...
                title="Detail Gedung & Bangunan"
                subtitle="Informasi Kartu Inventaris — KIB C"
                maxWidth="4xl"
                accentColor="violet"
                headerVariant="gradient"
                ...
                {selectedItemForDetail && (
                    <div className="space-y-8 py-2">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                                        <div className="w-1 h-3 bg-violet-400 rounded-full"></div>
                                        <h5 className="text-[10pt] font-black text-gray-400 uppercase tracking-[0.2em]">Identifikasi Aset</h5>
                                    </div>
                                    <div className="space-y-4">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[9pt] font-bold text-gray-400 uppercase tracking-wider">Nama Gedung</span>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span className="text-[9pt] font-bold text-gray-600 bg-gray-50 px-3 py-2 rounded-xl border border-gray-100 leading-relaxed">
                                                {selectedItemForDetail.ruangans?.length ? selectedItemForDetail.ruangans.map(r => r.nama_ruangan).join(', ') : (selectedItemForDetail.ruangan?.nama_ruangan || 'TIDAK TERHUBUNG')}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                                        ...
                                        <h5 className="text-[10pt] font-black text-gray-400 uppercase tracking-[0.2em]">Spesifikasi Gedung</h5>
                                    </div>
                                    <div className="bg-gray-50/50 rounded-2xl border border-gray-100 p-5 space-y-4">
                                        {[
                                            ...
                                            { label: 'Konstruksi', value: selectedItemForDetail.kib_c?.kondisi_bangunan || '-' },
                                            { label: 'Struktur', value: `${selectedItemForDetail.kib_c?.konstruksi_bertingkat ? 'BERTINGKAT' : 'SATU LANTAI'}, ${selectedItemForDetail.kib_c?.konstruksi_beton ? 'BETON' : 'KAYU/LAINNYA'}` },
                        ...
                        <div className="bg-gray-50/50 p-5 rounded-2xl border border-gray-100 flex flex-col gap-2">
                            <span className="text-[7.5pt] font-black text-gray-400 uppercase tracking-widest">Alamat Lokasi Gedung</span>
                            <span className="text-[9pt] font-bold text-gray-700 leading-relaxed">{selectedItemForDetail.kib_c?.letak_alamat}</span>
                        </div>
                        ...
                        {selectedItemForDetail.keterangan && (
                            <div className="bg-violet-50/20 p-6 rounded-3xl border border-violet-100/50">
                                <h6 className="text-[8pt] font-black text-violet-600 uppercase tracking-[0.2em] mb-3">Catatan / Keterangan</h6>
